import { ChartLine, CircleDollarSign, PlayCircle, StarIcon, Users } from "lucide-react";
...
const Dashboard = () => {
  ...
  return !loading ? (
    <>
      ...
      <p className="text-lg mt-10 font-medium">Active Shows</p>
      <div className="flex relative flex-wrap gap-6 mt-4 max-w-5xl">
        <BlurCircle top="100px" left="-10px"/>
        {
          dashboardData.activeShows.map((show)=>(
            <div key={show._id} className="w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:translate-y-1 transition  duration-300">
              <img src={show.movie.poster_path} className="h-60 object-cover w-full"  alt="" />
