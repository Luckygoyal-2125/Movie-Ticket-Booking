  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
      ...
      <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
        ...
        <button onClick={()=>navigate('/my-booking')} className="flex items-center gap-1 px-10 py-3 mt-20 bg-primary text-sm font-medium rounded-full hover:bg-primary-dull transition cursor-pointer active:scale-95">
          Proceed to Checkout
